            ...
            <SimpleGrid columns={2} spacing={"70px"}>
              <Stack spacing={"14px"}>
                ...
                {userAdmin && (
                  <>
                    ...
                    <Input
                      ...
                      value={newData.irb_number}
                      onChange={(e) =>
                        setNewData({ ...newData, irb_number: e.target.value })
                      }
                    ></Input>
                  </>
                )}
                ...
                <Select
                  ...
                  value={newData.project_lead}
                  onChange={(e) =>
                    setNewData({ ...newData, project_lead: e.target.value })
                  }
                >
                  {LeaderData.map((item) => {
                    return (
              ...
              <Stack>
                ...
                <Input
                  ...
                  value={newData.hypothesis}
                  onChange={(e) =>
                    setNewData({ ...newData, hypothesis: e.target.value })
                  }
                ></Input>
                <Spacer />
                ...
                <Textarea
                  ...
                  value={newData.testing}
                  onChange={(e) =>
                    setNewData({ ...newData, testing: e.target.value })
                  }
                ></Textarea>
                <Spacer />
                <Text>Status</Text>
                ...
                <Textarea
                  ...
                  value={newData.commitment}
                  onChange={(e) =>
                    setNewData({ ...newData, commitment: e.target.value })
                  }
                ></Textarea>
                <Spacer />
                <Text>Goal</Text>
